          ...
          children: [
            ...
            _buildColorGrid(
              ...
              [
                ...
                ColorSwatch(name: 'Background Light', color: AppColors.backgroundLight),
                ColorSwatch(name: 'Background Dark', color: AppColors.backgroundDark),
            ...
            _buildColorGrid(
              ...
              [
                ...
                ColorSwatch(name: 'Primary Container', color: colorScheme.primaryContainer),
                ColorSwatch(name: 'On Primary Container', color: colorScheme.onPrimaryContainer),
                ColorSwatch(name: 'Secondary', color: colorScheme.secondary),
                ColorSwatch(name: 'On Secondary', color: colorScheme.onSecondary),
                ColorSwatch(name: 'Secondary Container', color: colorScheme.secondaryContainer),
                ColorSwatch(name: 'On Secondary Container', color: colorScheme.onSecondaryContainer),
                ColorSwatch(name: 'Tertiary', color: colorScheme.tertiary),
                ColorSwatch(name: 'On Tertiary', color: colorScheme.onTertiary),
                ColorSwatch(name: 'Tertiary Container', color: colorScheme.tertiaryContainer),
                ColorSwatch(name: 'On Tertiary Container', color: colorScheme.onTertiaryContainer),
                ColorSwatch(name: 'Surface', color: colorScheme.surface),
                ColorSwatch(name: 'On Surface', color: colorScheme.onSurface),
                ColorSwatch(name: 'Surface Variant', color: colorScheme.surfaceVariant),
                ColorSwatch(name: 'On Surface Variant', color: colorScheme.onSurfaceVariant),
                ColorSwatch(name: 'Outline', color: colorScheme.outline),
                ColorSwatch(name: 'Shadow', color: colorScheme.shadow),
                ColorSwatch(name: 'Inverse Surface', color: colorScheme.inverseSurface),
                ColorSwatch(name: 'On Inverse Surface', color: colorScheme.onInverseSurface),
                ColorSwatch(name: 'Inverse Primary', color: colorScheme.inversePrimary),
                ColorSwatch(name: 'Error', color: colorScheme.error),
                ColorSwatch(name: 'On Error', color: colorScheme.onError),
                ColorSwatch(name: 'Error Container', color: colorScheme.errorContainer),
                ColorSwatch(name: 'On Error Container', color: colorScheme.onErrorContainer),
                ColorSwatch(name: 'Background', color: colorScheme.background),
                ColorSwatch(name: 'On Background', color: colorScheme.onBackground),
      ...
      child: InkWell(
        onTap: () {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Copied ${name}: Color(${color.value.toRadixString(16).padLeft(8, 'f')})')),
          );
        },
        child: Container(
